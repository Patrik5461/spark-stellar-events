...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Eventy, ktoré majú drive. Ľudia, ktorí majú iskru. Hostesky, promotéri, helperi a produkcia eventov na Slovensku aj v zahraničí." },
      { property: "og:title", content: "NU-U — Hostessing & Event Staffing Agency" },
      { property: "og:description", content: "Eventy, ktoré majú drive. Ľudia, ktorí majú iskru. Hostesky, promotéri, helperi a produkcia eventov na Slovensku aj v zahraničí." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "NU-U — Hostessing & Event Staffing Agency" },
      { name: "twitter:description", content: "Eventy, ktoré majú drive. Ľudia, ktorí majú iskru. Hostesky, promotéri, helperi a produkcia eventov na Slovensku aj v zahraničí." },
