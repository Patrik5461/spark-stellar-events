...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "NU-U — Hostessing & Event Staffing Agency" },
      ...
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/lOFHZOOkiRR7cK4ktaqRZYRGDW13/social-images/social-1785837442045-social-image.webp" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/lOFHZOOkiRR7cK4ktaqRZYRGDW13/social-images/social-1785837442045-social-image.webp" },
    ],
    links: [
