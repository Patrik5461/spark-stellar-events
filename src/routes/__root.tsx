...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:description", content: "Ľudia,ktorí vedia,čorobia.\nProfesionálny hostessing, promotéri, helperi a kompletné personálne zabezpečenie eventov na Slovensku." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/d70c2403-8f49-4332-b54d-3ad57180dc5e" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/d70c2403-8f49-4332-b54d-3ad57180dc5e" },
    ],
    links: [
