...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "NU-U — Hostessingová a eventová agentúra" },
      { name: "twitter:description", content: "Ľudia, ktorí vedia, čo robia. Profesionálny hostessing, promotéri, helperi a kompletné personálne zabezpečenie eventov na Slovensku." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/lOFHZOOkiRR7cK4ktaqRZYRGDW13/social-images/social-1785837961559-social-image.webp" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/lOFHZOOkiRR7cK4ktaqRZYRGDW13/social-images/social-1785837961559-social-image.webp" },
    ],
    links: [
