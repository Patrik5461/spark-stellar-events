...
import { LogOut, Image as ImageIcon, Settings, Wrench, MessageSquare, Activity, AlertTriangle, Shirt, Users, FileText, Calendar, LayoutDashboard, Wallet } from "lucide-react";
    ...
    <div className="min-h-screen bg-[#EBE6E2] text-[#383B3A]">
      <aside className="fixed left-0 top-0 bottom-0 w-64 bg-[#F5F1EC] border-r border-[#D9D2CC] flex flex-col">
        <div className="px-6 py-6 border-b border-[#D9D2CC]">
          <Link to="/" aria-label="NU-U — domov" className="inline-flex text-[#383B3A] hover:opacity-80 transition-opacity"><Logo className="h-[80px] w-[80px]" /></Link>
